...
import { Calendar, ShieldCheck, ArrowRight, Loader2, Mail, Lock, AlertCircle } from "lucide-react";
...
function SignInContent() {
  ...
  const callbackUrl = searchParams.get("callbackUrl") || "/demo-salon/dashboard";
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-[350px] h-[350px] bg-indigo-600/15 rounded-full blur-[120px] pointer-events-none" />
      ...
      <Card className="w-full max-w-md border border-slate-800 bg-slate-900/80 backdrop-blur-xl relative z-10 shadow-2xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold text-white">Welcome back to Bookora</CardTitle>
        ...
        <CardContent className="space-y-5 pt-4">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900/90 px-3 text-slate-400 font-medium">Or continue with email</span>
            </div>
          </div>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-900/90 px-3 text-slate-400 font-medium">Demo Access</span>
            </div>
          </div>

          <Link href="/demo-salon/dashboard" className="block">
            <Button variant="outline" className="w-full justify-between group border-slate-800 hover:bg-slate-800/60">
              <span className="text-sm text-slate-300">Enter Demo Salon Dashboard</span>
        ...
        <CardFooter className="flex flex-col gap-3 border-t border-slate-800/60 pt-4 text-center">
          ...
          <div className="flex items-center gap-2 justify-center text-xs text-slate-500">
            ...
            <span>256-bit encrypted secure session authentication</span>
          </div>
        </CardFooter>
      </Card>
    </div>
