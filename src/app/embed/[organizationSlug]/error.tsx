...
export default function EmbedError({
  ...
  useEffect(() => {
    console.error("Embed booking page error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-slate-900 border border-slate-800 rounded-2xl p-8 text-center space-y-4">
        ...
        <h2 className="text-xl font-bold text-white">Embedded Booking Error</h2>
        <p className="text-sm text-slate-400">
          {error.message || "Failed to load the embedded booking widget. Please try again."}
        </p>
