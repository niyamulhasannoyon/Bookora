...
export default function Loading() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <Skeleton className="h-16 w-full bg-slate-900/60 border border-slate-800 rounded-2xl" />
      <Skeleton className="h-96 w-full bg-slate-900/60 border border-slate-800 rounded-2xl" />
    </div>
  );
}
